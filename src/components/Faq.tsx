...
export function Faq() {
  return (
    <div className="flex flex-col items-center justify-center mx-auto w-full max-w-[928px] p-8 mt-16 bg-gray-100 rounded-2xl">
      <div className="flex flex-col items-center gap-2 mb-8">
        <h2 className="font-heading text-4xl">Dúvidas frequentes</h2>
        <p className="text-gray-500 text-center">Se você ainda tiver outras dúvidas, sinta-se a vontade para conversar conosco, envie-nos um e-mail para <a href="" className="font-semibold">suporte@decideai.com.br</a> </p>
      </div>
      <Disclosure as="div" className="border-y border-gray-300 w-full">
        {({ open }) => (
          <>
            <Disclosure.Button className="flex w-full justify-between p-3 text-left font-bold text-blue-800 hover:bg-gray-300 focus:outline-none focus-visible:ring focus-visible:ring-gray-500 focus-visible:ring-opacity-75">
              <span>Como anunciar meu estabelecimento?</span>
              {
      ...
      <Disclosure as="div" className="border-b border-gray-300 w-full">
        {({ open }) => (
          <>
            <Disclosure.Button className="flex w-full justify-between p-3 text-left font-bold text-blue-800 hover:bg-gray-300 focus:outline-none focus-visible:ring focus-visible:ring-gray-500 focus-visible:ring-opacity-75">
              <span>Como destacar meu estabelecimento dos demais?</span>
              {
                open ? <Minus /> : <Plus size={16} weight="fill" />
              }
            </Disclosure.Button>
      ...
      <Disclosure as="div" className="border-b border-gray-300 w-full">
        {({ open }) => (
          <>
            <Disclosure.Button className="flex w-full justify-between p-3 text-left font-bold text-blue-800 hover:bg-gray-300 focus:outline-none focus-visible:ring focus-visible:ring-gray-500 focus-visible:ring-opacity-75">
              <span>Não encontro uma categoria específica, o que fazer?</span>
              {
                open ? <Minus /> : <Plus size={16} weight="fill" />
              }
            </Disclosure.Button>
